...
import com.and.framework.common.widget.swipetoloadlayout.view.footer.ClassicLoadMoreFooterView;
...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    public void setIsLoadMoreEnd(boolean isLoadMoreEnd) {
        ...
        if (mFooterView != null) {
            ((ClassicLoadMoreFooterView) mFooterView).setIsLoadMoreEnd(isLoadMoreEnd);
        }
    }
    ...
    public void setLoadingMore(boolean loadingMore) {
        if (!isLoadMoreEnabled() || mFooterView == null||(isLoadMoreEnd&&loadingMore)){
            return;
        }
        ...
        if (mTargetView != null) {
            ...
            switch (mStyle) {
                ...
                case STYLE.ABOVE:
                    ...
                    if (((mFooterView != null && mFooterView.isShown()) || mStatus == STATUS.STATUS_SWIPING_TO_LOAD_MORE || mStatus == STATUS.STATUS_RELEASE_TO_LOAD_MORE)) {//上拉刷新加载更多
                        // classic
                        targetTop = paddingTop + lp.topMargin + mTargetOffset;
                    } else {
                        // above
